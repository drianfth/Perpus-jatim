          ...
          <div class="card-body">
            ...
            <div class="author-box-details pl-sm-3">
              <div class="author-box-description text-left">
                ...
                <p class="mb-0"><span class="font-weight-bold">Nomor Telepon : </span>{{ auth()->user()->no_telp }}</p>
              </div>
            </div>
            <div class="d-flex justify-content-center justify-content-sm-end mt-3">
              <a href="/profil/{{ auth()->user()->id }}" class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i> Edit</a>
            </div>
          </div>
        </div>
    </div>
